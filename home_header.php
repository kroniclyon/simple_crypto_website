...
<div class="col-sm-3" style="margin: 10px; margin-left: 60px; text-align: center;">
<button style="margin: 5px; font-size: 16px;" type="button" class="btn btn-info btn-lg"><a class="text-white " href="user/user_login.php"><i class='far fa-user-circle' style='font-size:24px'></i> Sign In</a></button>
<button  style="margin: 5px; font-size: 16px;" type="button" class="btn btn-warning btn-lg"><a class="text-white " href="user/user_registration.php"><i class='fas fa-user-edit' style='font-size:24px'></i> Register</a></button><br><br>
</div>	
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    ...
    <a href="user/user_registration.php">Register an Account</a>
    <a href="user/user_login.php">Login an Account</a>
