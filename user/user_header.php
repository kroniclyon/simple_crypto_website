...
<body>
  ...
  <div class="rows">
    <div class="col-sm-3">
      <img class="rounded" src="../logo/logo121.png" width="100px" height="100px" style="margin-bottom:5px; margin-top: 10px;";>
...
<div id="myNav" class="overlay">
  ...
  <div class="overlay-content">
    <a href="user_dashboard.php">Account Overview</a>
    <a href="redeem_funds.php">Redeem Giveaway Bonus</a>
    <a href="investment_programs.php">Deposit</a>
...
<span class="pull-right text-white" style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Dashboard</span>
