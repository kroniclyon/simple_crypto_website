...
s1.async=true;
s1.src='https://embed.tawk.to/5ea6459435bcbb0c9ab4e835/default';
s1.charset='UTF-8';
  ...
  <h2 class="jumbotron w3-center w3-large">List of Sellers</h2>
    ...
    <tbody class=" w3-border-left">
      <tr class="w3-border-left">
        ...
        <td><a href="contact_btc_seller_home.php?id=<?php echo $row ['id']; ?>" class="btn btn-outline-warning w3-large" role="button">BUY</a></td>
      </tr>
      <tr>
    </tbody>
  </table>
